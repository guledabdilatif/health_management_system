                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="row g-3">
                      ...
                      <div className="col-md-6">
                        ...
                        <input type="text" name="staffId" className="form-control" value={formData.staffId} onChange={handleChange} required />
                      </div>
                      ...
                      <div className="col-md-6 d-flex align-items-center gap-3">
                        ...
                        <div className="form-check">
                          <input type="checkbox" name="isSuspended" checked={formData.isSuspended} onChange={handleChange} className="form-check-input" />
                      ...
                      <div className="col-md-6">
                        ...
                        <input type="text" name="profilePhoto" className="form-control" value={formData.profilePhoto} onChange={handleChange} />
                      </div>

                      {/* Emergency Contact Name */}
                      <div className="col-md-6">
                        <label className="form-label">Emergency Contact Name</label>
                        <input type="text" name="emergencyContactName" className="form-control" value={formData.emergencyContactName} onChange={handleChange} />
                      </div>

                      {/* Emergency Contact Phone */}
                      <div className="col-md-6">
                        <label className="form-label">Emergency Contact Phone</label>
                        <input type="text" name="emergencyContactPhone" className="form-control" value={formData.emergencyContactPhone} onChange={handleChange} />
                      </div>
                      ...
                      <div className="col-md-6">
                        ...
                        <input type="date" name="licenseExpiry" className="form-control" value={formData.licenseExpiry} onChange={handleChange} />
                      </div>
                      ...
                      <div className="col-md-6">
                        ...
                        <input type="number" name="consultationFee" className="form-control" value={formData.consultationFee} onChange={handleChange} />
                      </div>
                    </div>
